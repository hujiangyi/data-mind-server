...
```bash
sudo DATAMIND_GO_INSTALL_MODE=update DATAMIND_GO_VERSION=v0.1.9 \
  bash ./install/install-go.sh

sudo DATAMIND_GO_INSTALL_MODE=new DATAMIND_GO_VERSION=v0.1.9 \
  bash ./install/install-go.sh

sudo DATAMIND_GO_INSTALL_MODE=reinstall \
  DATAMIND_GO_REINSTALL_CONFIRM=REINSTALL DATAMIND_GO_VERSION=v0.1.9 \
  bash ./install/install-go.sh
```
...
```bash
sudo DATAMIND_CURL_NO_PROXY=1 DATAMIND_GO_VERSION=v0.1.9 bash ./install/install-go.sh
```
...
sudo DATAMIND_CURL_PROXY=http://proxy.example.com:8080 \
  DATAMIND_GO_VERSION=v0.1.9 bash ./install/install-go.sh
```
