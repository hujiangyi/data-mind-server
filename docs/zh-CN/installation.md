...
```bash
sudo DATAMIND_GO_INSTALL_MODE=update DATAMIND_GO_VERSION=v0.1.8 \
  bash ./install/install-go.sh

sudo DATAMIND_GO_INSTALL_MODE=new DATAMIND_GO_VERSION=v0.1.8 \
  bash ./install/install-go.sh

sudo DATAMIND_GO_INSTALL_MODE=reinstall \
  DATAMIND_GO_REINSTALL_CONFIRM=REINSTALL DATAMIND_GO_VERSION=v0.1.8 \
  bash ./install/install-go.sh
```
