...
```bash
mkdir -p /tmp/datamind-v0.1.5-gitee-check
curl -fL -o /tmp/datamind-v0.1.5-gitee-check/server.tar.gz \
  https://gitee.com/hujiangyi/data-mind-server/releases/download/v0.1.5/datamind-go-linux-amd64.tar.gz
tar -tzf /tmp/datamind-v0.1.5-gitee-check/server.tar.gz | \
